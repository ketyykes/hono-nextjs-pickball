...
// matchmaker 區段外框：對戰頁（/matchmaker）、參賽者名單頁（/matchmaker/players）
// 與歷史頁（/matchmaker/history）共用同一份區段導覽，三頁因此都能互相切換
// （spec「對戰頁路由與 matchmaker 區段動線」，SHALL NOT 只在對戰頁提供單向連結）。本檔屬例外層（純入口，design
