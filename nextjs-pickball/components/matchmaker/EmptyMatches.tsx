...
const EMPTY_MATCHES_TITLE = "本輪目前沒有任何場次";
const EMPTY_MATCHES_DESCRIPTION = "候選人數不足以組成任何一場比賽，請前往參賽者名單調整出場狀態或補充人數。";
	...
	return (
		...
		>
			<div className="space-y-1">
				...
				<p className="text-sm text-muted-foreground">{EMPTY_MATCHES_DESCRIPTION}</p>
			</div>
			<Button asChild>
